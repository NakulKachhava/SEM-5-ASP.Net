...
export default function ManageStudentsView({ navigateTo }) {
  return (
    <div className="animate-fade-in">
      <PageShell
        ...
        onAction={() => navigateTo('add-student')}
      />
                ...
                <tr key={s.UserID}>
                  ...
                  <td>
                    <div className="td-actions">
                      ...
                      <button className="action-icon-btn edit" title="Edit" onClick={() => navigateTo('edit-student', { id: s.UserID })}>
                      ...
                      <button className="action-icon-btn delete" title="Delete" onClick={() => window.confirm('Delete this student?')}>
