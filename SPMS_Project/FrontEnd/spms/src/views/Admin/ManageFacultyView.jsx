...
export default function ManageFacultyView({ navigateTo }) {
  return (
    <div className="animate-fade-in">
      <PageShell
        ...
        onAction={() => navigateTo('add-faculty')}
      />
                ...
                <tr key={f.UserID}>
                  ...
                  <td>
                    <div className="td-actions">
                      ...
                      <button className="action-icon-btn edit" title="Edit" onClick={() => navigateTo('edit-faculty', { id: f.UserID })}>
                      ...
                      <button className="action-icon-btn delete" title="Delete" onClick={() => window.confirm('Delete this faculty?')}>
