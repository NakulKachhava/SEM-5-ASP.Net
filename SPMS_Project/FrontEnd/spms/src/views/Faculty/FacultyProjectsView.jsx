...
export default function FacultyProjectsView({ navigateTo }) {
  return (
                ...
                <tr key={p.ProjectAllocationID}>
                  ...
                  <td>
                    <div className="td-actions">
                      ...
                      <button className="action-icon-btn edit" title="Edit" onClick={() => navigateTo('edit-allocation', { id: p.ProjectAllocationID })}>
