...
export default function ScoresRemarksView({ navigateTo }) {
  return (
            ...
            <div className="glass-card score-card" key={task.TaskID}>
              ...
              <div className="score-evaluation-section">
                ...
                <div className="score-card-actions">
                  <button className="page-action-btn" style={{ fontSize: '0.82rem', padding: '8px 16px' }}
                    onClick={() => navigateTo('grade-task', { id: task.TaskID })}>
